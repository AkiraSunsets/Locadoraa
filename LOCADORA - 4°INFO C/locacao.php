                    ...
                    <tbody>
                        ...
                        while($dados = mysqli_fetch_assoc($rs)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?menu=locacao&idCliente=<?= $idCliente?>&idLocacao=<?=$idLocacao?>&menuOpLocacao=baixaVideo&Video&idFilme=<?=$dados["idFilme"]?>">
                                        Baixar
                                    </a>
                                </td>

                                <td>
                                    <a href="index.php?menu=locacao&idCliente=<?= $idCliente?>&idLocacao=<?=$idLocacao?>&menuOpLocacao=removeVideo&Video&idFilme=<?=$dados["idFilme"]?>">
                                        Remover
                                    </a>
                                </td>
                            </tr>
